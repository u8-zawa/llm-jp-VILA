...
#SBATCH --job-name=vila_step1  # name
#SBATCH --nodes=8              # nodes
#SBATCH --ntasks-per-node=1    # crucial - only 1 task per dist per node!
#SBATCH --gres=gpu:8           # number of gpus
#SBATCH --time 168:00:00       # maximum execution time (HH:MM:SS)
#SBATCH --output=step1.out     # output file name
...
export STAGE1_PATH="./checkpoints/llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-0"

OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-1"
export OUTPUT_PATH="./checkpoints/$OUTPUT"
