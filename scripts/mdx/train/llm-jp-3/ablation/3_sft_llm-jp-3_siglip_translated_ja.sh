...
#SBATCH --output=step_2_20241009.out     # output file name
#SBATCH --error=step_2_20241009.err
...
OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-2_translated_ja_20241009"
