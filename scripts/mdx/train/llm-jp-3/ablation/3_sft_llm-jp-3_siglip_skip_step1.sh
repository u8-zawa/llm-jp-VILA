...
#SBATCH --output=step_2_20241005.out     # output file name
#SBATCH --error=step_2_20241005.err
...
OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-2_skip_step-1_20241005"
