...
#SBATCH --output=step_1_20241008.out         # output file name
#SBATCH --error=step_1_20241008.err
...
OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-1_wo_interleaved_20241008"
...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --version llmjp_v3 \
    --data_mixture coyo_6m+llm_jp_mm_pair_step1_6m \
