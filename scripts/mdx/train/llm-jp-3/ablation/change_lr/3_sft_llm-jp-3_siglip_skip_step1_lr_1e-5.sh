...
#SBATCH --output=step_2_skip_lr_20241011.out
#SBATCH --error=step_2_skip_lr_20241011.err
...
OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-2_skip_step-1_lr_1e-5_20241011"
