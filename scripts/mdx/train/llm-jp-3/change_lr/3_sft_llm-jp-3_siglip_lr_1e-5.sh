...
#SBATCH --job-name=0050_vila_step2       # name
#SBATCH --nodes=4                        # nodes
#SBATCH --ntasks-per-node=1              # crucial - only 1 task per dist per node!
#SBATCH --gres=gpu:8                     # number of gpus
#SBATCH --time 96:00:00                  # maximum execution time (HH:MM:SS)
#SBATCH --output=step_2_lr_20241011.out  # output file name
#SBATCH --error=step_2_lr_20241011.err
...
OUTPUT="llm-jp-3-13b-instruct_siglip_mlp2xgelu_step-2_lr_1e-5_20241011"
export OUTPUT_PATH=/model/experiments/0050_vila_step2/checkpoints/$OUTPUT
